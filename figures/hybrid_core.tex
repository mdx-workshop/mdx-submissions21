\begin{tikzpicture}[
    ...
    \node (specimg) [anchor=north east] at ($ (spec) + (-1cm, 0.8cm) $) {\includegraphics[width=2.5cm]{figures/andr_mix.png}};
    ...
    \node [anchor=south] at ($ (d1z) + (-3cm, \yshift) $) {\includegraphics[width=2cm]{figures/andr_drums.png}};
    \node [anchor=south] at ($ (d1z) + (-1cm, \yshift) $) {\includegraphics[width=2cm]{figures/andr_bass.png}};
    \node [anchor=south] at ($ (d1z) + (1cm, \yshift) $) {\includegraphics[width=2cm]{figures/andr_other.png}};
    \node [anchor=south] at ($ (d1z) + (3cm, \yshift) $) {\includegraphics[width=2cm]{figures/andr_vocals.png}};
